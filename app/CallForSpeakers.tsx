  ...
  return (
    <section className="section-padding bg-gradient-to-b from-dark-bg to-dark-bg border-t border-dark-border">
      <div className="max-w-5xl mx-auto">
        <div className="bg-dark-card border border-lime/30 rounded-2xl p-6 md:p-16 text-center animate-slide-up">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-gray-300 mb-6 md:mb-8 leading-relaxed max-w-3xl mx-auto">
            We are seeking intellectuals, auditors, & whistleblowers.
          </p>

          <p className="text-sm sm:text-base text-gray-400 mb-8 md:mb-10 max-w-3xl mx-auto leading-relaxed">
          ...
          <a
            ...
            className="inline-flex btn-primary text-lg sm:text-xl justify-center"
          >
            Apply Now
          </a>
        </div>
